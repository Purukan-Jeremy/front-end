...
while(q<students.length){
    console.log(students[q].firstname);
    q++;
}
...
let p = 0
do{
    console.log(students[p].firstname);
    p++;
...
//1.
let outputCountryIndex = countries.findIndex(function(item){
    return item === "Indonesia";
});
console.log("Indonesia index =" ,outputCountryIndex);

//2.
let filterCountry = countries.filter(function(item){
